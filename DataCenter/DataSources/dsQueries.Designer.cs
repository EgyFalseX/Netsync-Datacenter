...
namespace DataCenter.DataSources.dsQueriesTableAdapters {
    ...
    public partial class QryItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT (SELECT AssociationId FROM Types AS Types_1 WHERE (TypeId = Item.TypeId)) " +
                "AS AssociationId, ISNULL((SELECT TOP (1) 1 AS CanDelete WHERE EXISTS (SELECT Cat" +
                "egoryId FROM CategoryRole AS T1 WHERE (GrantId = 1) AND (CategoryId = Item.Categ" +
                "oryId) AND (CanDelete = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_2" +
                "0 WHERE (RoleId = T1.RoleID) AND (UserId = @UserId) AND (T1.GrantId = 1))) AND (" +
                "NOT EXISTS (SELECT CategoryId FROM CategoryRole AS CategoryRole_9 WHERE (GrantId" +
                " = 2) AND (CategoryId = Item.CategoryId) AND (CanDelete = 1) AND EXISTS (SELECT " +
                "RoleId FROM UserRole AS UserRole_19 WHERE (RoleId = CategoryRole_9.RoleID) AND (" +
                "UserId = @UserId) AND (CategoryRole_9.GrantId = 2)))) AND (NOT EXISTS (SELECT Ca" +
                "tegoryId FROM CategoryUser AS CategoryUser_10 WHERE (GrantId = 2) AND (CategoryI" +
                "d = Item.CategoryId) AND (CanDelete = 1) AND (UserID = @UserId))) AND (NOT EXIST" +
                "S (SELECT ItemId FROM ItemRole AS T1 WHERE (GrantId = 2) AND (ItemId = Item.Item" +
                "Id) AND (CanDelete = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_15 W" +
                "HERE (RoleId = T1.RoleID) AND (UserId = @UserId) AND (T1.GrantId = 2)))) AND (NO" +
                "T EXISTS (SELECT ItemId FROM ItemUser AS ItemUser_10 WHERE (GrantId = 2) AND (It" +
                "emId = Item.ItemId) AND (CanDelete = 1) AND (UserID = @UserId))) OR (NOT EXISTS " +
                "(SELECT CategoryId FROM CategoryRole AS CategoryRole_8 WHERE (GrantId = 2) AND (" +
                "CategoryId = Item.CategoryId) AND (CanDelete = 1) AND EXISTS (SELECT RoleId FROM" +
                " UserRole AS UserRole_18 WHERE (RoleId = CategoryRole_8.RoleID) AND (UserId = @U" +
                "serId) AND (CategoryRole_8.GrantId = 2)))) AND (NOT EXISTS (SELECT CategoryId FR" +
                "OM CategoryUser AS CategoryUser_9 WHERE (GrantId = 2) AND (CategoryId = Item.Cat" +
                "egoryId) AND (CanDelete = 1) AND (UserID = @UserId))) AND (NOT EXISTS (SELECT It" +
                "emId FROM ItemRole AS T1 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (Can" +
                "Delete = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_14 WHERE (RoleId" +
                " = T1.RoleID) AND (UserId = @UserId) AND (T1.GrantId = 2)))) AND (NOT EXISTS (SE" +
                "LECT ItemId FROM ItemUser AS ItemUser_9 WHERE (GrantId = 2) AND (ItemId = Item.I" +
                "temId) AND (CanDelete = 1) AND (UserID = @UserId))) AND EXISTS (SELECT CategoryI" +
                "d FROM CategoryUser AS CategoryUser_6 WHERE (GrantId = 1) AND (CategoryId = Item" +
                ".CategoryId) AND (CanDelete = 1) AND (UserID = @UserId)) OR (NOT EXISTS (SELECT " +
                "CategoryId FROM CategoryRole AS CategoryRole_7 WHERE (GrantId = 2) AND (Category" +
                "Id = Item.CategoryId) AND (CanDelete = 1) AND EXISTS (SELECT RoleId FROM UserRol" +
                "e AS UserRole_17 WHERE (RoleId = CategoryRole_7.RoleID) AND (UserId = @UserId) A" +
                "ND (CategoryRole_7.GrantId = 2)))) AND (NOT EXISTS (SELECT CategoryId FROM Categ" +
                "oryUser AS CategoryUser_8 WHERE (GrantId = 2) AND (CategoryId = Item.CategoryId)" +
                " AND (CanDelete = 1) AND (UserID = @UserId))) AND (NOT EXISTS (SELECT ItemId FRO" +
                "M ItemRole AS T1 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (CanDelete =" +
                " 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_13 WHERE (RoleId = T1.Ro" +
                "leID) AND (UserId = @UserId) AND (T1.GrantId = 2)))) AND (NOT EXISTS (SELECT Ite" +
                "mId FROM ItemUser AS ItemUser_8 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) A" +
                "ND (CanDelete = 1) AND (UserID = @UserId))) AND EXISTS (SELECT ItemId FROM ItemR" +
                "ole AS T1 WHERE (GrantId = 1) AND (ItemId = Item.ItemId) AND (CanDelete = 1) AND" +
                " EXISTS (SELECT RoleId FROM UserRole AS UserRole_11 WHERE (RoleId = T1.RoleID) A" +
                "ND (UserId = @UserId) AND (T1.GrantId = 1))) OR (NOT EXISTS (SELECT CategoryId F" +
                "ROM CategoryRole AS CategoryRole_6 WHERE (GrantId = 2) AND (CategoryId = Item.Ca" +
                "tegoryId) AND (CanDelete = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRol" +
                "e_16 WHERE (RoleId = CategoryRole_6.RoleID) AND (UserId = @UserId) AND (Category" +
                "Role_6.GrantId = 2)))) AND (NOT EXISTS (SELECT CategoryId FROM CategoryUser AS C" +
                "ategoryUser_7 WHERE (GrantId = 2) AND (CategoryId = Item.CategoryId) AND (CanDel" +
                "ete = 1) AND (UserID = @UserId))) AND (NOT EXISTS (SELECT ItemId FROM ItemRole A" +
                "S T1 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (CanDelete = 1) AND EXIS" +
                "TS (SELECT RoleId FROM UserRole AS UserRole_12 WHERE (RoleId = T1.RoleID) AND (U" +
                "serId = @UserId) AND (T1.GrantId = 2)))) AND (NOT EXISTS (SELECT ItemId FROM Ite" +
                "mUser AS ItemUser_7 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (CanDelet" +
                "e = 1) AND (UserID = @UserId))) AND EXISTS (SELECT ItemId FROM ItemUser AS ItemU" +
                "ser_6 WHERE (GrantId = 1) AND (ItemId = Item.ItemId) AND (CanDelete = 1) AND (Us" +
                "erID = @UserId))), 0) AS CanDelete, ISNULL((SELECT TOP (1) 1 AS CanInsert WHERE " +
                "EXISTS (SELECT CategoryId FROM CategoryRole AS T1 WHERE (GrantId = 1) AND (Categ" +
                "oryId = Item.CategoryId) AND (CanInsert = 1) AND EXISTS (SELECT RoleId FROM User" +
                "Role AS UserRole_30 WHERE (RoleId = T1.RoleID) AND (UserId = @UserId) AND (T1.Gr" +
                "antId = 1))) AND (NOT EXISTS (SELECT CategoryId FROM CategoryRole AS CategoryRol" +
                "e_13 WHERE (GrantId = 2) AND (CategoryId = Item.CategoryId) AND (CanInsert = 1) " +
                "AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_29 WHERE (RoleId = CategoryR" +
                "ole_13.RoleID) AND (UserId = @UserId) AND (CategoryRole_13.GrantId = 2)))) AND (" +
                "NOT EXISTS (SELECT CategoryId FROM CategoryUser AS CategoryUser_15 WHERE (GrantI" +
                "d = 2) AND (CategoryId = Item.CategoryId) AND (CanInsert = 1) AND (UserID = @Use" +
                "rId))) AND (NOT EXISTS (SELECT ItemId FROM ItemRole AS T1 WHERE (GrantId = 2) AN" +
                "D (ItemId = Item.ItemId) AND (CanInsert = 1) AND EXISTS (SELECT RoleId FROM User" +
                "Role AS UserRole_25 WHERE (RoleId = T1.RoleID) AND (UserId = @UserId) AND (T1.Gr" +
                "antId = 2)))) AND (NOT EXISTS (SELECT ItemId FROM ItemUser AS ItemUser_15 WHERE " +
                "(GrantId = 2) AND (ItemId = Item.ItemId) AND (CanInsert = 1) AND (UserID = @User" +
                "Id))) OR (NOT EXISTS (SELECT CategoryId FROM CategoryRole AS CategoryRole_12 WHE" +
                "RE (GrantId = 2) AND (CategoryId = Item.CategoryId) AND (CanInsert = 1) AND EXIS" +
                "TS (SELECT RoleId FROM UserRole AS UserRole_28 WHERE (RoleId = CategoryRole_12.R" +
                "oleID) AND (UserId = @UserId) AND (CategoryRole_12.GrantId = 2)))) AND (NOT EXIS" +
                "TS (SELECT CategoryId FROM CategoryUser AS CategoryUser_14 WHERE (GrantId = 2) A" +
                "ND (CategoryId = Item.CategoryId) AND (CanInsert = 1) AND (UserID = @UserId))) A" +
                "ND (NOT EXISTS (SELECT ItemId FROM ItemRole AS T1 WHERE (GrantId = 2) AND (ItemI" +
                "d = Item.ItemId) AND (CanInsert = 1) AND EXISTS (SELECT RoleId FROM UserRole AS " +
                "UserRole_24 WHERE (RoleId = T1.RoleID) AND (UserId = @UserId) AND (T1.GrantId = " +
                "2)))) AND (NOT EXISTS (SELECT ItemId FROM ItemUser AS ItemUser_14 WHERE (GrantId" +
                " = 2) AND (ItemId = Item.ItemId) AND (CanInsert = 1) AND (UserID = @UserId))) AN" +
                "D EXISTS (SELECT CategoryId FROM CategoryUser AS CategoryUser_11 WHERE (GrantId " +
                "= 1) AND (CategoryId = Item.CategoryId) AND (CanInsert = 1) AND (UserID = @UserI" +
                "d)) OR (NOT EXISTS (SELECT CategoryId FROM CategoryRole AS CategoryRole_11 WHERE" +
                " (GrantId = 2) AND (CategoryId = Item.CategoryId) AND (CanInsert = 1) AND EXISTS" +
                " (SELECT RoleId FROM UserRole AS UserRole_27 WHERE (RoleId = CategoryRole_11.Rol" +
                "eID) AND (UserId = @UserId) AND (CategoryRole_11.GrantId = 2)))) AND (NOT EXISTS" +
                " (SELECT CategoryId FROM CategoryUser AS CategoryUser_13 WHERE (GrantId = 2) AND" +
                " (CategoryId = Item.CategoryId) AND (CanInsert = 1) AND (UserID = @UserId))) AND" +
                " (NOT EXISTS (SELECT ItemId FROM ItemRole AS T1 WHERE (GrantId = 2) AND (ItemId " +
                "= Item.ItemId) AND (CanInsert = 1) AND EXISTS (SELECT RoleId FROM UserRole AS Us" +
                "erRole_23 WHERE (RoleId = T1.RoleID) AND (UserId = @UserId) AND (T1.GrantId = 2)" +
                "))) AND (NOT EXISTS (SELECT ItemId FROM ItemUser AS ItemUser_13 WHERE (GrantId =" +
                " 2) AND (ItemId = Item.ItemId) AND (CanInsert = 1) AND (UserID = @UserId))) AND " +
                "EXISTS (SELECT ItemId FROM ItemRole AS T1 WHERE (GrantId = 1) AND (ItemId = Item" +
                ".ItemId) AND (CanInsert = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole" +
                "_21 WHERE (RoleId = T1.RoleID) AND (UserId = @UserId) AND (T1.GrantId = 1))) OR " +
                "(NOT EXISTS (SELECT CategoryId FROM CategoryRole AS CategoryRole_10 WHERE (Grant" +
                "Id = 2) AND (CategoryId = Item.CategoryId) AND (CanInsert = 1) AND EXISTS (SELEC" +
                "T RoleId FROM UserRole AS UserRole_26 WHERE (RoleId = CategoryRole_10.RoleID) AN" +
                "D (UserId = @UserId) AND (CategoryRole_10.GrantId = 2)))) AND (NOT EXISTS (SELEC" +
                "T CategoryId FROM CategoryUser AS CategoryUser_12 WHERE (GrantId = 2) AND (Categ" +
                "oryId = Item.CategoryId) AND (CanInsert = 1) AND (UserID = @UserId))) AND (NOT E" +
                "XISTS (SELECT ItemId FROM ItemRole AS T1 WHERE (GrantId = 2) AND (ItemId = Item." +
                "ItemId) AND (CanInsert = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_" +
                "22 WHERE (RoleId = T1.RoleID) AND (UserId = @UserId) AND (T1.GrantId = 2)))) AND" +
                " (NOT EXISTS (SELECT ItemId FROM ItemUser AS ItemUser_12 WHERE (GrantId = 2) AND" +
                " (ItemId = Item.ItemId) AND (CanInsert = 1) AND (UserID = @UserId))) AND EXISTS " +
                "(SELECT ItemId FROM ItemUser AS ItemUser_11 WHERE (GrantId = 1) AND (ItemId = It" +
                "em.ItemId) AND (CanInsert = 1) AND (UserID = @UserId))), 0) AS CanInsert, 1 AS C" +
                "anRead, ISNULL((SELECT TOP (1) 1 AS CanWrite WHERE EXISTS (SELECT CategoryId FRO" +
                "M CategoryRole AS T1 WHERE (GrantId = 1) AND (CategoryId = Item.CategoryId) AND " +
                "(CanWrite = 1) AND EXISTS (SELECT RoleId FROM UserRole WHERE (RoleId = T1.RoleID" +
                ") AND (UserId = @UserId) AND (T1.GrantId = 1))) AND (NOT EXISTS (SELECT Category" +
                "Id FROM CategoryRole WHERE (GrantId = 2) AND (CategoryId = Item.CategoryId) AND " +
                "(CanWrite = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_39 WHERE (Rol" +
                "eId = CategoryRole.RoleID) AND (UserId = @UserId) AND (CategoryRole.GrantId = 2)" +
                "))) AND (NOT EXISTS (SELECT CategoryId FROM CategoryUser WHERE (GrantId = 2) AND" +
                " (CategoryId = Item.CategoryId) AND (CanWrite = 1) AND (UserID = @UserId))) AND " +
                "(NOT EXISTS (SELECT ItemId FROM ItemRole AS T1 WHERE (GrantId = 2) AND (ItemId =" +
                " Item.ItemId) AND (CanWrite = 1) AND EXISTS (SELECT RoleId FROM UserRole AS User" +
                "Role_35 WHERE (RoleId = T1.RoleID) AND (UserId = @UserId) AND (T1.GrantId = 2)))" +
                ") AND (NOT EXISTS (SELECT ItemId FROM ItemUser WHERE (GrantId = 2) AND (ItemId =" +
                " Item.ItemId) AND (CanWrite = 1) AND (UserID = @UserId))) OR (NOT EXISTS (SELECT" +
                " CategoryId FROM CategoryRole AS CategoryRole_16 WHERE (GrantId = 2) AND (Catego" +
                "ryId = Item.CategoryId) AND (CanWrite = 1) AND EXISTS (SELECT RoleId FROM UserRo" +
                "le AS UserRole_38 WHERE (RoleId = CategoryRole_16.RoleID) AND (UserId = @UserId)" +
                " AND (CategoryRole_16.GrantId = 2)))) AND (NOT EXISTS (SELECT CategoryId FROM Ca" +
                "tegoryUser AS CategoryUser_19 WHERE (GrantId = 2) AND (CategoryId = Item.Categor" +
                "yId) AND (CanWrite = 1) AND (UserID = @UserId))) AND (NOT EXISTS (SELECT ItemId " +
                "FROM ItemRole AS T1 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (CanWrite" +
                " = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_34 WHERE (RoleId = T1." +
                "RoleID) AND (UserId = @UserId) AND (T1.GrantId = 2)))) AND (NOT EXISTS (SELECT I" +
                "temId FROM ItemUser AS ItemUser_19 WHERE (GrantId = 2) AND (ItemId = Item.ItemId" +
                ") AND (CanWrite = 1) AND (UserID = @UserId))) AND EXISTS (SELECT CategoryId FROM" +
                " CategoryUser AS CategoryUser_16 WHERE (GrantId = 1) AND (CategoryId = Item.Cate" +
                "goryId) AND (CanWrite = 1) AND (UserID = @UserId)) OR (NOT EXISTS (SELECT Catego" +
                "ryId FROM CategoryRole AS CategoryRole_15 WHERE (GrantId = 2) AND (CategoryId = " +
                "Item.CategoryId) AND (CanWrite = 1) AND EXISTS (SELECT RoleId FROM UserRole AS U" +
                "serRole_37 WHERE (RoleId = CategoryRole_15.RoleID) AND (UserId = @UserId) AND (C" +
                "ategoryRole_15.GrantId = 2)))) AND (NOT EXISTS (SELECT CategoryId FROM CategoryU" +
                "ser AS CategoryUser_18 WHERE (GrantId = 2) AND (CategoryId = Item.CategoryId) AN" +
                "D (CanWrite = 1) AND (UserID = @UserId))) AND (NOT EXISTS (SELECT ItemId FROM It" +
                "emRole AS T1 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (CanWrite = 1) A" +
                "ND EXISTS (SELECT RoleId FROM UserRole AS UserRole_33 WHERE (RoleId = T1.RoleID)" +
                " AND (UserId = @UserId) AND (T1.GrantId = 2)))) AND (NOT EXISTS (SELECT ItemId F" +
                "ROM ItemUser AS ItemUser_18 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (" +
                "CanWrite = 1) AND (UserID = @UserId))) AND EXISTS (SELECT ItemId FROM ItemRole A" +
                "S T1 WHERE (GrantId = 1) AND (ItemId = Item.ItemId) AND (CanWrite = 1) AND EXIST" +
                "S (SELECT RoleId FROM UserRole AS UserRole_31 WHERE (RoleId = T1.RoleID) AND (Us" +
                "erId = @UserId) AND (T1.GrantId = 1))) OR (NOT EXISTS (SELECT CategoryId FROM Ca" +
                "tegoryRole AS CategoryRole_14 WHERE (GrantId = 2) AND (CategoryId = Item.Categor" +
                "yId) AND (CanWrite = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_36 W" +
                "HERE (RoleId = CategoryRole_14.RoleID) AND (UserId = @UserId) AND (CategoryRole_" +
                "14.GrantId = 2)))) AND (NOT EXISTS (SELECT CategoryId FROM CategoryUser AS Categ" +
                "oryUser_17 WHERE (GrantId = 2) AND (CategoryId = Item.CategoryId) AND (CanWrite " +
                "= 1) AND (UserID = @UserId))) AND (NOT EXISTS (SELECT ItemId FROM ItemRole AS T1" +
                " WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (CanWrite = 1) AND EXISTS (S" +
                "ELECT RoleId FROM UserRole AS UserRole_32 WHERE (RoleId = T1.RoleID) AND (UserId" +
                " = @UserId) AND (T1.GrantId = 2)))) AND (NOT EXISTS (SELECT ItemId FROM ItemUser" +
                " AS ItemUser_17 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (CanWrite = 1" +
                ") AND (UserID = @UserId))) AND EXISTS (SELECT ItemId FROM ItemUser AS ItemUser_1" +
                "6 WHERE (GrantId = 1) AND (ItemId = Item.ItemId) AND (CanWrite = 1) AND (UserID " +
                "= @UserId))), 0) AS CanWrite, CategoryId, (SELECT CategoryName FROM Category WHE" +
                "RE (CategoryId = Item.CategoryId)) AS CategoryName, CreateIn, Info, ItemId, Item" +
                "Name, Locker, ModifyIn, OwnerId, PhysicalName, (SELECT RealName FROM Users WHERE" +
                " (UserID = Item.UserIn)) AS RealNameLastEdit, (SELECT RealName FROM Users AS Use" +
                "rs_1 WHERE (UserID = Item.OwnerId)) AS RealNameOwner, (SELECT TypeIconData FROM " +
                "Types AS Types_2 WHERE (TypeId = Item.TypeId)) AS TypeIconData, TypeId, (SELECT " +
                "TypeName FROM Types WHERE (TypeId = Item.TypeId)) AS TypeName, UserIn, active FR" +
                "OM Item WHERE (CategoryId = @CategoryId) AND (active = 1) AND EXISTS (SELECT Cat" +
                "egoryId FROM CategoryRole AS CategoryRole_5 WHERE (GrantId = 1) AND (CategoryId " +
                "= Item.CategoryId) AND (CanRead = 1) AND EXISTS (SELECT RoleId FROM UserRole AS " +
                "UserRole_10 WHERE (UserId = @UserId) AND (CategoryRole_5.GrantId = 1))) AND (NOT" +
                " EXISTS (SELECT CategoryId FROM CategoryRole AS CategoryRole_4 WHERE (GrantId = " +
                "2) AND (CategoryId = Item.CategoryId) AND (CanRead = 1) AND EXISTS (SELECT RoleI" +
                "d FROM UserRole AS UserRole_9 WHERE (UserId = @UserId) AND (CategoryRole_4.Grant" +
                "Id = 2)))) AND (NOT EXISTS (SELECT CategoryId FROM CategoryUser AS CategoryUser_" +
                "5 WHERE (GrantId = 2) AND (CategoryId = Item.CategoryId) AND (CanRead = 1) AND (" +
                "UserID = @UserId))) AND (NOT EXISTS (SELECT ItemId FROM ItemRole WHERE (GrantId " +
                "= 2) AND (ItemId = Item.ItemId) AND (CanRead = 1) AND EXISTS (SELECT RoleId FROM" +
                " UserRole AS UserRole_5 WHERE (UserId = @UserId) AND (ItemRole.GrantId = 2)))) A" +
                "ND (NOT EXISTS (SELECT ItemId FROM ItemUser AS ItemUser_5 WHERE (GrantId = 2) AN" +
                "D (ItemId = Item.ItemId) AND (CanRead = 1) AND (UserID = @UserId))) OR (Category" +
                "Id = @CategoryId) AND (active = 1) AND (NOT EXISTS (SELECT CategoryId FROM Categ" +
                "oryRole AS CategoryRole_3 WHERE (GrantId = 2) AND (CategoryId = Item.CategoryId)" +
                " AND (CanRead = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_8 WHERE (" +
                "UserId = @UserId) AND (CategoryRole_3.GrantId = 2)))) AND (NOT EXISTS (SELECT Ca" +
                "tegoryId FROM CategoryUser AS CategoryUser_4 WHERE (GrantId = 2) AND (CategoryId" +
                " = Item.CategoryId) AND (CanRead = 1) AND (UserID = @UserId))) AND (NOT EXISTS (" +
                "SELECT ItemId FROM ItemRole AS ItemRole_4 WHERE (GrantId = 2) AND (ItemId = Item" +
                ".ItemId) AND (CanRead = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_4" +
                " WHERE (UserId = @UserId) AND (ItemRole_4.GrantId = 2)))) AND (NOT EXISTS (SELEC" +
                "T ItemId FROM ItemUser AS ItemUser_4 WHERE (GrantId = 2) AND (ItemId = Item.Item" +
                "Id) AND (CanRead = 1) AND (UserID = @UserId))) AND EXISTS (SELECT CategoryId FRO" +
                "M CategoryUser AS CategoryUser_1 WHERE (GrantId = 1) AND (CategoryId = Item.Cate" +
                "goryId) AND (CanRead = 1) AND (UserID = @UserId)) OR (CategoryId = @CategoryId) " +
                "AND (active = 1) AND (NOT EXISTS (SELECT CategoryId FROM CategoryRole AS Categor" +
                "yRole_2 WHERE (GrantId = 2) AND (CategoryId = Item.CategoryId) AND (CanRead = 1)" +
                " AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_7 WHERE (UserId = @UserId) " +
                "AND (CategoryRole_2.GrantId = 2)))) AND (NOT EXISTS (SELECT CategoryId FROM Cate" +
                "goryUser AS CategoryUser_3 WHERE (GrantId = 2) AND (CategoryId = Item.CategoryId" +
                ") AND (CanRead = 1) AND (UserID = @UserId))) AND (NOT EXISTS (SELECT ItemId FROM" +
                " ItemRole AS ItemRole_3 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (CanR" +
                "ead = 1) AND EXISTS (SELECT RoleId FROM UserRole AS UserRole_3 WHERE (UserId = @" +
                "UserId) AND (ItemRole_3.GrantId = 2)))) AND (NOT EXISTS (SELECT ItemId FROM Item" +
                "User AS ItemUser_3 WHERE (GrantId = 2) AND (ItemId = Item.ItemId) AND (CanRead =" +
                " 1) AND (UserID = @UserId))) AND EXISTS (SELECT ItemId FROM ItemRole AS ItemRole" +
                "_1 WHERE (GrantId = 1) AND (ItemId = Item.ItemId) AND (CanRead = 1) AND EXISTS (" +
                "SELECT RoleId FROM UserRole AS UserRole_1 WHERE (UserId = @UserId) AND (ItemRole" +
                "_1.GrantId = 1))) OR (CategoryId = @CategoryId) AND (active = 1) AND (NOT EXISTS" +
                " (SELECT CategoryId FROM CategoryRole AS CategoryRole_1 WHERE (GrantId = 2) AND " +
                "(CategoryId = Item.CategoryId) AND (CanRead = 1) AND EXISTS (SELECT RoleId FROM " +
                "UserRole AS UserRole_6 WHERE (UserId = @UserId) AND (CategoryRole_1.GrantId = 2)" +
                "))) AND (NOT EXISTS (SELECT CategoryId FROM CategoryUser AS CategoryUser_2 WHERE" +
                " (GrantId = 2) AND (CategoryId = Item.CategoryId) AND (CanRead = 1) AND (UserID " +
                "= @UserId))) AND (NOT EXISTS (SELECT ItemId FROM ItemRole AS ItemRole_2 WHERE (G" +
                "rantId = 2) AND (ItemId = Item.ItemId) AND (CanRead = 1) AND EXISTS (SELECT Role" +
                "Id FROM UserRole AS UserRole_2 WHERE (UserId = @UserId) AND (ItemRole_2.GrantId " +
                "= 2)))) AND (NOT EXISTS (SELECT ItemId FROM ItemUser AS ItemUser_2 WHERE (GrantI" +
                "d = 2) AND (ItemId = Item.ItemId) AND (CanRead = 1) AND (UserID = @UserId))) AND" +
                " EXISTS (SELECT ItemId FROM ItemUser AS ItemUser_1 WHERE (GrantId = 1) AND (Item" +
