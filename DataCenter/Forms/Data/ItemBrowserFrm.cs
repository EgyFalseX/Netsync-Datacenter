...
namespace DataCenter.Forms
{
    public partial class ItemBrowserFrm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void addSubCategory()
        {
            ...
            row.ParentID = dsQueries.QryCategory[tlCategory.FocusedNode.Id].CategoryId; row.active = true;
        ...
        private void viewFile()
        {
            ...
            {
                case (int)DataCenterX.AssociationType.Unknown:
                    break;
                case (int)DataCenterX.AssociationType.Image:
                    ImageViewerFrm FrmImageViewer = new ImageViewerFrm(row) { MdiParent = this.ParentForm };
                     FrmImageViewer.Show();
                    break;
                case (int)DataCenterX.AssociationType.Word:
                    MSWordViewerFrm FrmMSWordViewer = new MSWordViewerFrm(row) { MdiParent = this.ParentForm };
                    FrmMSWordViewer.Show();
                    break;
                case (int)DataCenterX.AssociationType.Excel:
                    MSExcelViewerFrm FrmMSExcelViewer = new MSExcelViewerFrm(row) { MdiParent = this.ParentForm };
                    FrmMSExcelViewer.Show();
                    break;
            }
        }
