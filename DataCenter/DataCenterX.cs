...
namespace DataCenter
{
    public class DataCenterX
    {
        ...
        public static bool StartApp()
        {
            ...
            {
                string msg = "لم نتمكن من الاتصال مع برنامج الخادم. يجب تشغيل برنامج" + Environment.NewLine;
                msg += "NetSync " + Environment.NewLine;
                msg += "علي الخادم ثم اعادة تشغل البرنامج";

                LogMessage(msg, typeof(DataCenterX), nsLib.Utilities.Types.MessageType.Error, null, true);
                return false;
            }
